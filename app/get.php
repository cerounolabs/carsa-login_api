<?php
    ...
    $app->get('/v1/400/colaborador', function($request) {
        ...
        a.NIVEL_JERARQUIA               AS          funcionario_jerarquia_nivel,
        ...
        try {
            ...
            while ($rowMSSQL = $stmtMSSQL->fetch()) {
                ...
                $detalle    = array(
                    ...
                    'funcionario_jerarquia_nivel'                               => $rowMSSQL['funcionario_jerarquia_nivel'],
            ...
            if (isset($result)){
                ...
                $detalle = array(
                    ...
                    'funcionario_jerarquia_codigo'                              => '',
                    'funcionario_jerarquia_nombre'                              => '',
    ...
    $app->get('/v1/400/gerencia', function($request) {
        require __DIR__.'/../src/connect.php';
